...
let favoriteFood = ['eggs', 'chicken', 'spinach'];
...
favoriteFood.push('tatertots');
console.log('Added food to the end,', favoriteFood);
...
favoriteFood.unshift('ceasar salad');
console.log(`Added food to the beginning: ${favoriteFood}`);
...
console.log('Removed the first food item', favoriteFood);
console.log('The foods are now', favoriteFood);
